...
const HexagonBackground = React.forwardRef<HTMLDivElement, HexagonBackgroundProps>(
    ({ className, children, hexagonProps, hexagonSize = 75, hexagonMargin = 3, ...props }, ref) => {
